...
WEB_CODEX_MODEL = os.environ.get("PAPER_READER_WEB_CODEX_MODEL", CODEX_MODEL or "gpt-5.4").strip()
WEB_CODEX_REASONING_EFFORT = os.environ.get("PAPER_READER_WEB_CODEX_REASONING_EFFORT", "xhigh").strip()
WEB_CODEX_TIMEOUT_SECONDS = int(os.environ.get("PAPER_READER_WEB_CODEX_TIMEOUT_SECONDS", str(CODEX_TIMEOUT_SECONDS)))
