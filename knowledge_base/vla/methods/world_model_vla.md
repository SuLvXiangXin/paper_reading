...
| **RISE** | 2602.11075 | OpenDriveLab/Kinetix | 2026.02 | compositional world model 作为训练环境：controllable dynamics model + progress value model 生成 imagined advantage，后训练 π0.5 类策略，部署时不增加推理成本 |
