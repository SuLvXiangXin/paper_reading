...
> 创建日期：2026-03-17
> 锚点论文：SONIC (2511.07820), HoloMotion-1 (2605.15336), HOVER (2410.21229), BeyondMimic (2508.08241)
...
| **Foundation Models** | 大规模预训练，泛化到多任务 | GR00T N1, SONIC (42M参数), HoloMotion-1 (400M MoE), ASAP |
...
| — | 2605.15336 | **HoloMotion-1** (anchor) | 2026 |

## 研究前沿（2025-2026）

- **大规模基础模型**：SONIC (42M参数, 700h动捕数据), GR00T N1
- **视频重建运动数据驱动的 WBC scaling**：HoloMotion-1 用 MotionMillion 等野外视频重建动作作为主数据源，结合 MoCap/in-house 遥操作数据训练稀疏 MoE Transformer 跟踪策略
- **运动重定向**：OmniRetarget, Retargeting Matters, SPIDER
- **交互式全身控制**：HDMI, CLONE, TWIST2
- **语言引导WBC**：LangWBC, FRoM-W1, TextOp
- **具身运动控制(VLA+WBC)**：WholeBodyVLA, EgoHumanoid, SENTINEL, VIRAL
- **高动态运动**：KungfuBot, Thor, OmniXtreme, BeyondMimic (空中翻转、旋踢), SMASH (humanoid 乒乓球)
- **敏捷-稳定统一**：Agility Meets Stability (AMS) 用异构 MoCap + 合成平衡数据补齐 dynamic agility 与 extreme balance 的分布缺口
